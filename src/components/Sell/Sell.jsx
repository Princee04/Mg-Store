            ...
            <div className="container mt-5">
                ...
                <div className="form-container mt-5">
                    <form>
                        <div className="row">
                            <div className="col-3">
                                <label className='form-label ' htmlFor="nom">Nom du Produit</label>
                                <input  type="text" id='nom' className="form-control" placeholder='nom du produit ici...'/>
                            </div>
                            <div className="col-3">
                                <label className='form-label ' htmlFor="prix">Prix du Produit</label>
                                <input type="number" id='prix' className="form-control" placeholder='nom du produit ici...'/>
                            </div>
                            <div className="col-6">
                                <label className='form-label ' htmlFor="category">Categories</label>
                                <select className='form-select' name="category" id="category">
                                    <option selected value="">Vetements</option>
                        ...
                        <div className="row mt-3">
                            <div className="col-5">
                                <label className='form-label' htmlFor="description">Description du Produit</label>
                                <textarea className='form-control'  name="" id="description" placeholder='quelques description ici..'></textarea>
                            </div>
                            <div className="col-6">
                                <div className="row">
                                    <label className='form-label' htmlFor="contact">Contact</label>
                                    <input type="text" id='contact' className='form-control' placeholder='votre numéro de téléphone...'/>
                                </div>
                                <div className="row mt-3">
                                <label className='form-label' htmlFor="province">Province</label>
                                    <select className='form-select' name="province" id="province">
                                        <option selected value="">Antananarivo</option>
                            ...
                            <button className="form-control btn btn-success mt-5">Valider</button>
                        </div>
                    </form>
                </div>
